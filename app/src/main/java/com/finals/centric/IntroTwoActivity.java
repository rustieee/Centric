...
import com.finals.centric.databinding.ActivityIntroTwoBinding;

public class IntroTwoActivity extends AppCompatActivity {

    ActivityIntroTwoBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        binding = ActivityIntroTwoBinding.inflate(getLayoutInflater());
        ...
        binding.next.setOnClickListener(v -> {
            v.animate()
                    ...
                    .withEndAction(() -> {
                        ...
                        startActivity(new Intent(this, IntroThreeActivity.class));
